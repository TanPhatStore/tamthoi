...
public class main extends JFrame implements MouseListener{
	...
	public main (String type, String nameEmploy, String phoneEmploy) throws IOException{
		...
		if (type.equals("NVQL")) {
			...
			boxTotal.add(menu);
			trangTongQuan = new trangTongQuan();
		...
		menu.menuYKien.addMouseListener(this);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(obj.equals(menu.subQLDV)) {
			...
			boxTotal.remove(1);
			trangDichVu = new trangDichVu("#5B86E5", "#FC466B", "Quan Li", trangHoaDon);
		...
		if(obj.equals(menu.subTCDV)) {
			boxTotal.remove(1);
			trangDichVu = new trangDichVu("#5B86E5", "#FC466B", "Tra Cuu", trangHoaDon);
			boxTotal.add(trangDichVu);
        	boxTotal.invalidate();
        	boxTotal.validate();
        	boxTotal.repaint();
		...
		if(obj.equals(menu.subLDV)) {
			boxTotal.remove(1);
			trangDichVu = new trangDichVu("#5B86E5", "#FC466B", "Loai", trangHoaDon);
			boxTotal.add(trangDichVu);
        	boxTotal.invalidate();
        	boxTotal.validate();
        	boxTotal.repaint();
		...
		if(obj.equals(menu.subNCC)) {
			boxTotal.remove(1);
			trangDichVu = new trangDichVu("#5B86E5", "#FC466B", "Nha Cung Cap", trangHoaDon);
			boxTotal.add(trangDichVu);
        	boxTotal.invalidate();
        	boxTotal.validate();
        	boxTotal.repaint();
		...
		if(obj.equals(menu.menuYKien)) {
			boxTotal.remove(1);
			trangYKien = new trangThongKe("#5B86E5", "#FC466B", "Y Kien");
			boxTotal.add(trangYKien);
			boxTotal.invalidate();
        	boxTotal.validate();
        	boxTotal.repaint();
		}
