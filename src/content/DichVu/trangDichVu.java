...
public class trangDichVu extends JPanel {
	...
	public trangDichVu (String color1, String color2, String type,trangHoaDon trangHoaDon) {
		...
		if (type == "Quan Li") {
			totalBox.removeAll();
			trangQLDV.RenderUIQuanLi(totalBox, fontBtn, color1, color2,trangHoaDon, frame);
		} else if (type == "Tra Cuu") {
			totalBox.removeAll();
