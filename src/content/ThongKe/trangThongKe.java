...
public class trangThongKe extends JPanel {
	...
	public trangThongKe (String color1, String color2, String type) {
		...
		if (type == "Hoa Don") {
			...
			menuPage = new menuPage(color1, color2, "Ý Kiến Khách Hàng", "hinh/menu/menu_LoaiDV.png");
		}
		add(menuPage);
		add(totalBox);
		...
		if (type == "Hoa Don") {
			...
			totalBox.removeAll();
			trangYKKH.RenderUIYKKH(totalBox);
		}
