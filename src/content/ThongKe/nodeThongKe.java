...
public class nodeThongKe extends JPanel {
	...
	private customComBoBox comboLeft;
	private Font fontBtn;
	public customButton btnXemThongKe;
	private customButton btnInThongKe;
	public customComBoBox comboLeft1;
	public customComBoBox comboLeft2;
	...
	public nodeThongKe (String color1, String color2, String type) {
		...
		comboLeft1 = new customComBoBox();
		comboLeft1.setFont(new Font ("Arial", 0, 17));
		if (type.equals("Hoa Don")) {
			comboLeft1.addItem("Thống Kê Khoảng Thu");
			comboLeft1.addItem("Thống Kê Khoảng Chi");
		} else if (type.equals("Khach Hang")) {
			comboLeft1.addItem("Thống Kê Khách Hàng");
		} else if (type.equals("Nhan Vien")) {
			comboLeft1.addItem("Thống Kê Nhân Viên");
		} else if (type.equals("Y Kien")) {
			comboLeft1.addItem("Thống Kê Ý Kiến");
		}
		...
		comboLeft1.setPreferredSize(new Dimension(300, 40));
