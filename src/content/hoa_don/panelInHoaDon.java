...
public class panelInHoaDon extends JPanel{
	...
	public JTextField tfTienKhachDua;
	...
	public panelInHoaDon () {
		...
		label1 = new JLabel("In Phiếu Tạm Tính");
		label1.setFont(new Font("", 0, 20));
		label1.setForeground(Color.white);
		label1.setIcon(new ImageIcon("hinh/menu/lbl_In1.png"));
		box1_1.add(label1);
		...
		box2.add(Box.createRigidArea(new Dimension(0, 20)));
		box2.add(box2_3);
		label2 = new JLabel("In Phiếu Thanh Toán");
		label2.setFont(new Font("", 0, 20));
		label2.setForeground(Color.white);
		label2.setIcon(new ImageIcon("hinh/menu/lbl_In1.png"));
		box2_1.add(label2);
		
		tfTienKhachDua = new JTextField();
		tfTienKhachDua.setBorder(new MatteBorder(0,0,2,0, Color.white));
		tfTienKhachDua.setBackground(null);
		tfTienKhachDua.setOpaque(false);
		tfTienKhachDua.setFont(new Font("", 0, 17));
		tfTienKhachDua.setForeground(Color.white);
		lblTien = new JLabel("Tiền Của Khách : ");
		lblTien.setFont(new Font("", 0, 17));
		lblTien.setForeground(Color.white);
		box2_2.add(lblTien);
		box2_2.add(tfTienKhachDua);
