...
public class titleHoaDon extends JPanel implements ActionListener {
    ...
    public titleHoaDon (String name, String time, int priceTotal1, String giaPhong) {
        ...
        boxTotal.add(title2);
        btnBamGio = new JButton("Tính Giờ");
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (obj.equals(btnBamGio)) {
            if (infoTime.getText().equals("Giờ Hát : ---")) {
                ...
                if (btnBamGio.getText().equals("Tính Giờ")) {
                    btnBamGio.setText("Đang Tính Giờ");
                    t.start();
                } else if (btnBamGio.getText().equals("Đang Tính Giờ")) {
                    btnBamGio.setText("Tính Giờ");
                    t.stop();
                }
            }
        }
