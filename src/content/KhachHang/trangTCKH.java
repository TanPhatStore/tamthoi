		...
		if (obj.equals(panel.btnTim)) {
			...
			for (int i = 0; i< row; i ++) {
				...
				if (panel.tfTenKH.getText().length() != 0) {
					x++;
					if (panel.tfTenKH.getText().trim().equals(pane.table.getValueAt(i,1).toString().trim())) {
						y ++;
					}
				}
				if (panel.tfDiaChiKH.getText().length() != 0) {
					x++;
					if (panel.tfDiaChiKH.getText().trim().equals(pane.table.getValueAt(i,2).toString().trim())) {
						y ++;
					}	
				}
				if (panel.tfSDTKH.getText().length() != 0) {
					...
					if (panel.tfSDTKH.getText().trim().equals(pane.table.getValueAt(i,3).toString().trim())) {
						y ++;
					}
				}
